...
/* ============================================================
   ACCORDION COMPONENT
   Using Radix UI with Framer Motion smooth expand
   ============================================================ */
...
>(({ className, ...props }, ref) => (
  <AccordionPrimitive.Item
    ref={ref}
    className={cn('border-b border-slate-blue-light', className)}
    {...props}
  />
));
...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        'flex flex-1 items-center justify-between py-4 text-sm font-medium text-white',
        'transition-all duration-200 hover:text-bronze',
