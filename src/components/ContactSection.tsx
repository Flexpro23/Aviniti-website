        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <button
              ...
              className="inline-flex items-center justify-center btn-primary text-lg group cursor-pointer"
            >
              Contact Us Now
            ...
            <a 
              ...
              className="inline-flex items-center justify-center btn-secondary text-lg group cursor-pointer"
            >
              Call Us Directly
