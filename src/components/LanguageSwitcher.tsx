  ...
  return (
    <div className="flex items-center gap-2">
      <select
        ...
        className={`backdrop-blur-sm border rounded-md px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-bronze-500 transition-colors cursor-pointer min-w-[100px] ${
          isScrolled
